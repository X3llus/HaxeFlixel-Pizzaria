...
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_images_pepperoni1_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_images_pepperoni2_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_images_pepperoni3_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_images_pepperoni_spritesheet_json extends null { }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_images_pepperoni_spritesheet_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_images_pizzalarge_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
...
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_images_round_dough_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
...
@:keep @:image("assets/images/pepperoni1.png") @:noCompletion #if display private #end class __ASSET__assets_images_pepperoni1_png extends lime.graphics.Image {}
@:keep @:image("assets/images/pepperoni2.png") @:noCompletion #if display private #end class __ASSET__assets_images_pepperoni2_png extends lime.graphics.Image {}
@:keep @:image("assets/images/pepperoni3.png") @:noCompletion #if display private #end class __ASSET__assets_images_pepperoni3_png extends lime.graphics.Image {}
@:keep @:file("assets/images/pepperoni_spritesheet.json") @:noCompletion #if display private #end class __ASSET__assets_images_pepperoni_spritesheet_json extends haxe.io.Bytes {}
@:keep @:image("assets/images/pepperoni_spritesheet.png") @:noCompletion #if display private #end class __ASSET__assets_images_pepperoni_spritesheet_png extends lime.graphics.Image {}
@:keep @:image("assets/images/pizzaLarge.png") @:noCompletion #if display private #end class __ASSET__assets_images_pizzalarge_png extends lime.graphics.Image {}
...
@:keep @:image("assets/images/round-dough.png") @:noCompletion #if display private #end class __ASSET__assets_images_round_dough_png extends lime.graphics.Image {}
