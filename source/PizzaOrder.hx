...
class PizzaOrder
{
	...
	public function displayOrder(pizzaOrder:PizzaOrder, textSauce:flixel.text.FlxText, textCheese:flixel.text.FlxText, textTopping:flixel.text.FlxText,
			textOrd:flixel.text.FlxText)
	{
